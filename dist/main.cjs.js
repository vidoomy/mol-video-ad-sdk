...
var innerXML = function(node) {
  ...
  return Array.prototype.map
    .call(node.childNodes, function(node) {
...
var getParseError = function(doc) {
  ...
  // Chrome, Safari
  if (
    (doc.documentElement.tagName === "xml" ||
...
var xmlToJson = function xmlToJson(node) {
  ...
  if (node.hasChildNodes()) {
    ...
    try {
      for (
        var _iterator2 = childNodes[Symbol.iterator](), _step2;
...
var filterChildrenByName = function filterChildrenByName(
  element,
  childrenName
) {
...
var getNonLinearTrackingEvents = function getNonLinearTrackingEvents(
  ad,
  eventName
) {
  var creativeElement = ad && getLinearCreative(ad);
...
var getIconAttributes = function getIconAttributes(iconElement) {
  var _getAttributes = getAttributes(iconElement),
    ...
    xPosition =
      _getAttributes$xPosit === undefined ? "right" : _getAttributes$xPosit,
    _getAttributes$yPosit = _getAttributes.yPosition,
    yPosition =
      _getAttributes$yPosit === undefined ? "top" : _getAttributes$yPosit;
...
var getIconViewTracking = function getIconViewTracking(iconElement) {
  var iconTrackingElements = getAll(iconElement, "IconViewTracking").map(
    function(iconViewTrackingElement) {
...
var getIconClicks = function getIconClicks(iconElement) {
  ...
  var iconClickThroughElement =
    iconClicksElement && get(iconClicksElement, "IconClickThrough");
  var iconClickTrackingElements =
    iconClicksElement &&
    getAll(iconClicksElement, "IconClickTracking").map(function(
    ...
    interactiveFiles = mediaFiles
      .filter(function(_ref2) {
        var _ref2$apiFramework = _ref2.apiFramework,
          apiFramework =
            _ref2$apiFramework === undefined ? "" : _ref2$apiFramework;
...
var trackIconView = function trackIconView(vastChain, _ref) {
  ...
  if (Array.isArray(iconViewTracking)) {
    ...
    try {
      for (
        var _iterator = iconViewTracking[Symbol.iterator](), _step;
        !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
        _iteratorNormalCompletion = true
      ) {
...
var trackIconClick = function trackIconClick(vastChain, _ref) {
  ...
  if (Array.isArray(iconClickTracking)) {
    ...
    try {
      for (
        var _iterator = iconClickTracking[Symbol.iterator](), _step;
        !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
        _iteratorNormalCompletion = true
      ) {
        var trackUrl = _step.value;
...
var createVastEventTracker = function createVastEventTracker(
  vastChainSelector
) {
...
var clickTrackingSelector = function clickTrackingSelector(ad) {
  ...
  if (Array.isArray(clickTrackings) && clickTrackings.length > 0) {
    trackingURIs.push.apply(
      trackingURIs,
      toConsumableArray(
        clickTrackings.map(function(uri) {
          return { uri: uri };
        })
      )
    );
...
var linearTrackers =
  ...
  defineProperty(
    _linearTrackers,
    clickThrough,
    createVastEventTracker(clickTrackingSelector)
  ),
  defineProperty(
    _linearTrackers,
    closeLinear,
  ...
  defineProperty(_linearTrackers, error, trackError),
  defineProperty(
    _linearTrackers,
    exitFullscreen,
  ...
  defineProperty(_linearTrackers, iconClick, trackIconClick),
  defineProperty(_linearTrackers, iconView, trackIconView),
  defineProperty(
    _linearTrackers,
    impression,
    createVastEventTracker(getImpressionUri)
  ),
  defineProperty(
    _linearTrackers,
    midpoint,
  ...
  defineProperty(_linearTrackers, progress, trackProgress),
  defineProperty(
    _linearTrackers,
    resume,
...
var linearTrackers$1 =
  ((_linearTrackers$1 = {}),
  defineProperty(
    _linearTrackers$1,
    acceptInvitation,
    createVastEventTracker(trackingEventSelector(acceptInvitation))
  ),
  defineProperty(
    _linearTrackers$1,
    adCollapse,
    createVastEventTracker(trackingEventSelector(adCollapse))
  ),
  defineProperty(
    _linearTrackers$1,
    close,
    createVastEventTracker(trackingEventSelector(close))
  ),
  defineProperty(
    _linearTrackers$1,
    creativeView,
    createVastEventTracker(trackingEventSelector(creativeView))
  ),
  _linearTrackers$1);
  ...
  createClass(VideoAdContainer, [
    {
      ...
      value: (function() {
        var _ref = asyncToGenerator(
          /*#__PURE__*/ regenerator.mark(function _callee(src) {
            var options =
              ...
              function _callee$(_context) {
                while (1) {
                  switch ((_context.prev = _context.next)) {
                    ...
                    case 7:
                      placeholder = getContentDocument(this[hidden].iframe)
                        .body;
 ...
 */
var createVideoAdContainer = function createVideoAdContainer(
  placeholder,
  videoElement
) {
  if (!placeholder) {
...
var getProgressEvents = function getProgressEvents(vastChain) {
  return vastChain
    ...
    .reduce(function(accumulated, ad) {
      ...
      return [].concat(
        toConsumableArray(accumulated),
        toConsumableArray(events)
      );
    }, [])
    .map(function(_ref2) {
...
var onFullscreenChange = function onFullscreenChange(_ref, callback) {
  ...
  try {
    for (
      var _iterator = fullscreenEvtNames[Symbol.iterator](), _step;
      !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
      _iteratorNormalCompletion = true
    ) {
  ...
  return function() {
    ...
    try {
      for (
        var _iterator2 = fullscreenEvtNames[Symbol.iterator](), _step2;
        !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done);
        _iteratorNormalCompletion2 = true
      ) {
...
var onSkip = function onSkip(videoAdContainer, callback) {
  var _ref =
    ...
    createSkipControl =
      _ref$createSkipContro === undefined
        ? createDefaultSkipControl
        : _ref$createSkipContro;
...
var onProgress = function onProgress(_ref2, callback) {
  ...
  var _ref3 =
    ...
    progressEvents =
      _ref3$progressEvents === undefined ? [] : _ref3$progressEvents;
  ...
  var progressHandler = function progressHandler() {
    ...
    var _pendingEvents$reduce = pendingEvents.reduce(
...
var onMutation = function onMutation(target, callback) {
  ...
  return function() {
    target[mutationHandlers] = target[mutationHandlers].filter(function(
      handler
    ) {
...
var onElementResize = function onElementResize(target, callback) {
  ...
  var stopObservingMutations = Boolean(MutationObserver)
...
var checkVisibility = function checkVisibility() {
  ...
  try {
    for (
      var _iterator = elementEntries[Symbol.iterator](), _step;
      !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
      _iteratorNormalCompletion = true
    ) {
...
var onElementVisibilityChange = function onElementVisibilityChange(
  target,
  callback
) {
  var _ref =
    ...
    scrollableElement =
      _ref$scrollableElemen === undefined ? window : _ref$scrollableElemen,
    _ref$viewabilityOffse = _ref.viewabilityOffset,
    viewabilityOffset =
      _ref$viewabilityOffse === undefined ? 0.4 : _ref$viewabilityOffse;

  validate$1(target, callback);

  var viewportEventHandler =
    threshold > 0 ? lodash_debounce(checkVisibility) : checkVisibility;
  ...
  return function() {
    ...
    if (
      elementEntries.every(function(elementEntry) {
...
var chooseIcons = function chooseIcons(icons) {
  ...
  return programs.reduce(function(accumulator, program) {
    if (program === UNKNOWN) {
      return [].concat(
        toConsumableArray(accumulator),
        toConsumableArray(byProgram[UNKNOWN])
      );
    }

    return [].concat(toConsumableArray(accumulator), [
...
var fetchHtml = (function() {
  var _ref = asyncToGenerator(
    /*#__PURE__*/ regenerator.mark(function _callee(endpoint) {
          ...
          while (1) {
            switch ((_context.prev = _context.next)) {
              ...
              case 8:
                ...
                _error = new Error(
                  "fetchHtml error, invalid Content-Type " + contentType
                );
...
var calculateIconLeft = function calculateIconLeft(
  dynamicPos,
  iconWidth,
  drawnIcons,
  phWidth
...
var calculateIconTop = function calculateIconTop(
  dynamicPos,
  iconHeight,
  phHeight
) {
...
var createIcon = (function() {
  var _ref2 = asyncToGenerator(
    /*#__PURE__*/ regenerator.mark(function _callee(icon, config) {
      var iconResource;
      return regenerator.wrap(
        function _callee$(_context) {
          while (1) {
...
var renderIcon = (function() {
  var _ref3 = asyncToGenerator(
    /*#__PURE__*/ regenerator.mark(function _callee2(icon, config) {
              ...
              case 3:
                ...
                if (!iconElement.parentNode || icon.updated) {
                  placeholder.appendChild(
                    updateIconElement(iconElement, updatedIcon)
                  );
                }
                _context2.next = 11;
                break;
...
var renderIcons = function renderIcons(icons, _ref) {
  ...
  var _icons$reduce = icons.reduce(
      function(accumulator, icon) {
...
var _hasPendingIconRedraws = function _hasPendingIconRedraws(
  icons,
  videoElement
) {
  var currentTimeInMs = videoElement.currentTime * 1000;
...
var addIcons = function addIcons(icons) {
  ...
  var videoAdContainer = _ref3.videoAdContainer,
    ...
    rest = objectWithoutProperties(_ref3, [
      "videoAdContainer",
      "onIconView",
      "onIconClick"
    ]);
...
var VideoAdUnit = (function(_Emitter) {
  ...
  function VideoAdUnit(vastChain, videoAdContainer) {
    ...
    var _this = possibleConstructorReturn(
      this,
      (VideoAdUnit.__proto__ || Object.getPrototypeOf(VideoAdUnit)).call(
        this,
        logger
      )
    );
    ...
    onFinishCallbacks.push(
      preventManualProgress(_this.videoAdContainer.videoElement)
    );
    ...
    if (viewability) {
      _this.once(start$2, function() {
        var unsubscribe = onElementVisibilityChange(
          _this.videoAdContainer.element,
          function(visible) {
            if (_this.isFinished()) {
              return;
            }
  ...
  createClass(VideoAdUnit, [
    ...
    },
    {
      ...
      value: function onFinish(callback) {
        ...
        this[_protected].onFinishCallbacks.push(
          safeCallback(callback, this.logger)
        );
      }
    ...
    },
    {
      ...
      value: function onError(callback) {
        ...
        this[_protected].onErrorCallbacks.push(
          safeCallback(callback, this.logger)
        );
      }
    ...
    },
    {
      ...
      value: (function() {
        var _ref2 = asyncToGenerator(
          /*#__PURE__*/ regenerator.mark(function _callee(width, height, mode) {
            return regenerator.wrap(
              function _callee$(_context) {
                while (1) {
                  switch ((_context.prev = _context.next)) {
...
var VastAdUnit = (function(_VideoAdUnit) {
  ...
  function VastAdUnit(vastChain, videoAdContainer) {
    ...
    var _this = possibleConstructorReturn(
      this,
      (VastAdUnit.__proto__ || Object.getPrototypeOf(VastAdUnit)).call(
        this,
        vastChain,
        videoAdContainer,
        options
      ...
      handleMetric: function handleMetric(event, data) {
        switch (event) {
          ...
          case errorEvt: {
            _this.error = data;
            _this.errorCode =
              _this.error && _this.error.code ? _this.error.code : 405;
                ...
                while (1) {
                  switch ((_context2.prev = _context2.next)) {
                    ...
                    case 3:
                      ...
                      (_videoAdContainer = this.videoAdContainer),
                        (videoElement = _videoAdContainer.videoElement),
                        (element = _videoAdContainer.element);
                ...
                while (1) {
                  switch ((_context3.prev = _context3.next)) {
                    case 0:
                      _context3.next = 2;
                      return get$1(
                        VastAdUnit.prototype.__proto__ ||
                          Object.getPrototypeOf(VastAdUnit.prototype),
                        "resize",
                        this
                      ).call(this, width, height, viewmode);

                    case 2:
                      if (this.isStarted() && !this.isFinished()) {
                        inlineAd = this.vastChain[0].ad;
                        (_videoAdContainer2 = this.videoAdContainer),
                          (videoElement = _videoAdContainer2.videoElement),
                          (element = _videoAdContainer2.element);
                        media = findBestMedia(inlineAd, videoElement, element);
      ...
      return regenerator.wrap(
        function _callee$(_context) {
          while (1) {
            switch ((_context.prev = _context.next)) {
              case 0:
                creative = (getInteractiveFiles(vastChain[0].ad) || []).filter(
                  isSupported
                )[0];
...
var vpaidGeneralError = function vpaidGeneralError(payload) {
  var error$$1 =
    payload instanceof Error ? payload : new Error("VPAID general error");
...
var VpaidAdUnit = (function(_VideoAdUnit) {
  ...
  function VpaidAdUnit(vastChain, videoAdContainer) {
    ...
    var _this = possibleConstructorReturn(
      this,
      (VpaidAdUnit.__proto__ || Object.getPrototypeOf(VpaidAdUnit)).call(
        this,
        vastChain,
        videoAdContainer,
        options
    ...
    _this[_private$1] = {
      evtHandler:
        ((_evtHandler = {}),
        defineProperty(_evtHandler, adClickThru, function(
          url,
          id,
          playerHandles
        ) {
            ...
            if (_this.paused()) {
              ...
              var clickThroughUrl =
                typeof url === "string" && url.length > 0
                  ? url
                  : getClickThrough(_this.vastChain[0].ad);
    ...
    _this[_private$1].loadCreativePromise = loadCreative(
      vastChain,
      videoAdContainer
    );
    return _this;
                ...
                while (1) {
                  switch ((_context2.prev = _context2.next)) {
                    ...
                    case 6:
                      ...
                      for (
                        _iterator = VPAID_EVENTS[Symbol.iterator]();
                        ...
                        this.creativeAd.subscribe(
                          this[_private$1].handleVpaidEvt.bind(
                            this,
                            creativeEvt
                          ),
                          creativeEvt
                ...
                while (1) {
                  switch ((_context4.prev = _context4.next)) {
                    case 0:
                      _context4.next = 2;
                      return get$1(
                        VpaidAdUnit.prototype.__proto__ ||
                          Object.getPrototypeOf(VpaidAdUnit.prototype),
                        "resize",
                        this
                      ).call(this, width, height, viewmode);
...
var createVideoAdUnit = function createVideoAdUnit(
  vastChain,
  videoAdContainer,
  options
) {
...
var startAdUnit = function startAdUnit(adUnit, _ref) {
  ...
  return new Promise(function(resolve, reject) {
    var createRejectHandler = function createRejectHandler(event) {
      return function() {
        return reject(
          new Error("Ad unit start rejected due to event '" + event + "'")
        );
      };
    };
...
var tryToStartVpaidAd = function tryToStartVpaidAd(
  vastChain,
  videoAdContainer,
  options
) {
          ...
          while (1) {
            switch ((_context.prev = _context.next)) {
              ...
              case 7:
                ...
                return _context.abrupt(
                  "return",
                  startVastAd(vastChain, videoAdContainer, options)
                );
...
var fetchAdXML = (function() {
  var _ref2 = asyncToGenerator(
    /*#__PURE__*/ regenerator.mark(function _callee(adTag, options) {
      var response, XML;
      return regenerator.wrap(
        function _callee$(_context) {
          while (1) {
...
var validateResponse = function validateResponse(_ref3, _ref4) {
  ...
  var _ref4$allowMultipleAd = _ref4.allowMultipleAds,
    allowMultipleAds =
      _ref4$allowMultipleAd === undefined ? true : _ref4$allowMultipleAd,
    _ref4$followAdditiona = _ref4.followAdditionalWrappers,
    followAdditionalWrappers =
      _ref4$followAdditiona === undefined ? true : _ref4$followAdditiona;
...
var requestAd = (function() {
  var _ref5 = asyncToGenerator(
    /*#__PURE__*/ regenerator.mark(function _callee2(adTag, options) {
      var vastChain =
        arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
...
var getNextAd = function getNextAd(_ref, _ref2) {
  ...
  var _ref2$fallbackOnNoAd = _ref2.fallbackOnNoAd,
    fallbackOnNoAd =
      _ref2$fallbackOnNoAd === undefined ? true : _ref2$fallbackOnNoAd,
...
var requestNextAd = function requestNextAd(VastChain, options) {
  ...
  if (Boolean(nextAd)) {
    ...
    var newVastChain = [newVastResponse].concat(
      toConsumableArray(VastChain.slice(1))
    );
...
var validateVastChain = function validateVastChain(vastChain, options) {
  ...
  if (
    options.hooks &&
    typeof options.hooks.validateVastResponse === "function"
  ) {
          ...
          while (1) {
            switch ((_context.prev = _context.next)) {
              ...
              case 13:
                ...
                _context.next = 17;
                return run(
                  transformVastResponse(vastChain, opts),
                  placeholder,
                  _extends({}, opts)
                );
...
exports.run = run;
exports.runWaterfall = runWaterfall;
exports.requestAd = requestAd;
exports.requestNextAd = requestNextAd;
exports.vastSelectors = index;
